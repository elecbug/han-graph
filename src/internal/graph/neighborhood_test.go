...
func TestNeighborhood(t *testing.T) {
	...
	wanted := map[string]bool{"感覺": true, "感情": true, "感謝": true, "感動": true, "共感": true, "視覺": true, "聽覺": true, "自覺": true, "覺悟": true, "感慨": true, "感慨無量": true, "感激": true, "自愧感": true, "鈍感": true, "淸涼感": true, "諒解覺書": true}
	...
	if len(characters) != 21 || !characters["情"] || !characters["視"] || !characters["慨"] || !characters["激"] || !characters["愧"] || !characters["鈍"] || characters["監"] || characters["勵"] || characters["羞"] || characters["愚"] || !characters["淸"] || !characters["涼"] || !characters["諒"] || !characters["解"] || !characters["書"] || characters["荒"] || characters["恕"] {
