...
func TestNeighborhood(t *testing.T) {
	...
	wanted := map[string]bool{"感覺": true, "感情": true, "感謝": true, "感動": true, "共感": true, "視覺": true, "聽覺": true, "自覺": true, "覺悟": true}
	...
	if len(characters) != 10 || !characters["情"] || !characters["視"] || characters["監"] {
