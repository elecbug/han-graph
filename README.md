...
현재는 한자 1,854개(독음 레코드 1,861개)와 단어 886개를 바탕으로 단어·한자 탐색, 연결 그래프, 단어장과 문맥 연습 6문항을 제공하는 로컬 웹 프로그램 및 Go CLI 단계입니다. 첫 190개 한자에 연결 단어를 최소 5개씩 채웠으며, 앞으로는 한 번에 20개 한자씩 확장합니다. 내역은 [데이터 작업 기록](./dataset/README.md)에 있습니다.
