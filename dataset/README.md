...
| `character.jsonl` | 글자 1,821개, 독음 레코드 1,822개: 중등 900, 고등 900, 확장 22 |
| `normal_word.jsonl` | 단어 199개, 한국어·영어 뜻, 구성 한자와 선택적 의미 힌트 |
...
`gam-003`부터 `gang-101`까지 다음 10개 한자에 연결 단어를 5개씩 채우고 새 단어 **50개**를 추가했다. 현재는 **199개 단어, 415개 단어–한자 연결, 연결된 한자 224개**다. 첫 40개 한자 모두 연결 단어가 5개씩이다.
